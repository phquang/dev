...
import kornia
from .buffer import BalancedBuffer as Buffer
...
class Net(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.buffer = Buffer(self.n_memories, input_shape = [3,32,32])
    ...
    def observe(self, x, t, y):
        ...
        for _ in range(self.inner_steps):
            ...
            if not self.buffer.is_empty():
                buff = self.buffer.get_data(self.bsz * 2)
                xx = buff['x']
        ...
        if not self.buffer.is_empty():
            buff  = self.buffer.get_data(self.bsz)
            xx, yy, t_,  buff_logits = buff['x'], buff['y'], buff['t'],  buff['l']
        ...
        self.buffer.add_reservoir({"x": x, "y": y, "t":t, 'l': pred.data})
        return 0.
